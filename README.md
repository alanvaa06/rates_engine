...
discounting, key-rate and duration risk, and swap hedging with futures strips.
...
```bash
pip install finport-ratesengine            # curves, pricing, risk, hedging
...
1. **v0.1** (PRD-001, this release): OIS-SOFR bootstrap from fixings, SR1/SR3
...
2. **v0.2** (PRD-002): Black and Bachelier swaptions, caps and floors, a SABR
   vol cube, Nelson-Siegel and FOMC-step curves, monotone-convex
   interpolation, an MCP server.
