"""AC-9.1: every public result serialises the same way, with no missing keys.
...
from rates_engine.risk import key_rate_dv01, money_convexity, pvbp
...
class TestErrorPayloads:
    """AC-9.3's shape: a failure is a document too."""
